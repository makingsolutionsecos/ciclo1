...
/**
 * Clase encargada de generar un análisis por cada archivo de un directorio y
 * extensión definido.
 *
 * @author Johans Gonzalez Fecha 3/04/2015
 * @version 1.0
 */
public class Analizador {
     ...
     *
     * @param ruta String Variable que contiene la ubicación del directorio a
     * examinar.
     * @param lenguaje LenguajeEnum Objeto que contiene el lenguaje que
     * determina la extensión y lineamientos para desarrollar el análisis.
     * @return un objeto de tipo RespuestaAnalisis con el anñalisis
     * desarrollado.
     */
