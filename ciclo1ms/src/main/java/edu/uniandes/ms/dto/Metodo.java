...
/**
 * Clase DTO que contiene la estructura de un archivo metodo contiene toda la
 * información de un metodo de una clase.
 *
...
public class Metodo {
     ...
     *
     * @param cantidadNumeroLLamados valor del numero de llamados del metodo a
     * establecer
     */
    ...
    /**
     * metodo encargado de establecer el valor de la cantidad de puntos de
     * decision del metodo
     *
     * @param cantidadPuntosDecision valor a establecer del numero de puntos de
     * deciison
     */
     ...
     * medicion de complejidad logica del metodo
     *
